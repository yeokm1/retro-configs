...
bios-micro8088.bin: bios.bin
	dd if=/dev/zero bs=1k count=40 | tr "\000" "\377" > bios-micro8088.bin
	cat bios.bin >> bios-micro8088.bin
	dd if=/dev/zero bs=1k count=64 | tr "\000" "\377" >> bios-micro8088.bin

bios-micro8088-xtide.bin: bios.bin ide_xt.bin
	cat ide_xt.bin > bios-micro8088-xtide.bin
	dd if=/dev/zero bs=1k count=32 | tr "\000" "\377" >> bios-micro8088-xtide.bin
	cat bios.bin >> bios-micro8088-xtide.bin
	dd if=/dev/zero bs=1k count=64 | tr "\000" "\377" >> bios-micro8088-xtide.bin

bios-sergey-xt.bin: bios.bin
	dd if=/dev/zero bs=1k count=96 | tr "\000" "\377" > bios-sergey-xt.bin
	cat bios.bin >> bios-sergey-xt.bin

bios-sergey-xt-xtide.bin: bios.bin ide_xt.bin
	dd if=/dev/zero bs=1k count=64 | tr "\000" "\377" > bios-sergey-xt-xtide.bin
	cat ide_xt.bin >> bios-sergey-xt-xtide.bin
	dd if=/dev/zero bs=1k count=24 | tr "\000" "\377" >> bios-sergey-xt-xtide.bin
	cat bios.bin >> bios-sergey-xt-xtide.bin

bios-xi8088.bin: bios.bin
	dd if=/dev/zero bs=1k count=32 | tr "\000" "\377" > bios-xi8088.bin
	cat bios.bin >> bios-xi8088.bin
	dd if=/dev/zero bs=1k count=64 | tr "\000" "\377" >> bios-xi8088.bin

bios-xi8088-xtide.bin: bios.bin ide_xt.bin
	cat ide_xt.bin > bios-xi8088-xtide.bin
	dd if=/dev/zero bs=1k count=24 | tr "\000" "\377" >> bios-xi8088-xtide.bin
	cat bios.bin >> bios-xi8088-xtide.bin
	dd if=/dev/zero bs=1k count=64 | tr "\000" "\377" >> bios-xi8088-xtide.bin
