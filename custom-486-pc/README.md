...
<img src="photos/eide-multiio.jpg" width="500">

QD6580 VLB Multi-IO card 

<img src="photos/sb16.jpg" width="500">

Creative Sound Blaster 16 CT2945 with genuine Yamaha OPL3
...
<img src="photos/serial.jpg" width="500">
...
The TBSW pin header on the left of the CPU socket has to be populated with an external switch or jumper in order to disable Turbo Mode. Otherwise your system will run very slow!
...
3. [Creative PnP Configuration Manager](https://support.creative.com/Products/ProductDetails.aspx?prodID=1842&prodName=Sound%20Blaster%2016)
